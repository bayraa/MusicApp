...
@implementation SymbolKeyboard_iphone
@synthesize keys;
@synthesize buttonArray;

+ (instancetype)sharedSymbolKeyboardView {
    static SymbolKeyboard_iphone *_sharedKeyboard = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sharedKeyboard = [[SymbolKeyboard_iphone alloc] initWithFrame:CGRectMake(0, 264, 320, 216)];
...
#pragma mark Line 1
    ...
    for (int i = 0; i<10; i++) {
        ...
        UIButton *button = nil;
        button = [self getButton:CGRectMake(boundX, boundY, 26, 45) bgImage:[UIImage imageNamed:@"button_useg_50x50.png"] tag:MY_KEY_OTHER title:self.keys[characterIndex++]];
...
#pragma mark Line 3
    ...
    for (int i = 0; i<9; i++) {
        ...
        if (i>=1 && i<8) {
            ...
            button = [self getButton:CGRectMake(boundX, boundY, 34, 45) bgImage:[UIImage imageNamed:@"button_dund_32x41.png"] tag:MY_KEY_NUMBER title:@"123"];
...
#pragma mark Line 4
    ...
    for (int i=0; i<4; i++) {
        ...
        UIButton *button = nil;
        if (i == 0) {
            button = [self getButton:CGRectMake(boundX, boundY, 34, 45) bgImage:[UIImage imageNamed:@"button_dund_32x41"] tag:MY_KEY_ENG title:@"En"];
            boundX += button.bounds.size.width + 6;
        } else if (i == 1) {
            ...
            button = [self getButton:CGRectMake(boundX, boundY, 73, 45) bgImage:[UIImage imageNamed:@"button_dund_71x41"] tag:MY_KEY_ENTER title:@"return"];
            boundX += button.bounds.size.width + 6;
        }
...
#pragma mark Line 3
    ...
    for (int i = 0; i<9; i++) {
        ...
        if (i>=1 && i<8) {
            ...
            button = [self getButton:CGRectMake(boundX, boundY, 60, 31) bgImage:[UIImage imageNamed:@"button_dund_52x31.png"] tag:MY_KEY_NUMBER title:@"123"];
